...
# direct methods
.method public static a(Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;)Lcom/autonavi/navigation/api/poi/model/DealerInfo;
    .locals 13
    ...
    :cond_0
    iget-object v0, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->Coord:Lcom/autonavi/xm/navigation/server/GCoord;
    ...
    iget v0, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->nID:I
    ...
    iget v2, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->eDealerType:I

    iget v3, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->eMotorType:I

    iget v5, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->nAdminCode:I

    iget-object v6, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->szName:Ljava/lang/String;

    iget-object v7, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->szAddr:Ljava/lang/String;

    iget-object v8, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->szTel:Ljava/lang/String;

    iget-object v9, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->szFax:Ljava/lang/String;

    iget v10, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->lDistance:I

    iget-short v11, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->siLonOff:S

    iget-short v12, p0, Lcom/autonavi/xm/navigation/server/poi/G4SDealerInfo;->siLatOff:S
...
.method public static a(Lcom/autonavi/xm/navigation/server/poi/GPoi;)Lcom/autonavi/navigation/api/poi/model/Poi;
    .locals 15
    ...
    iget v0, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lPoiId:I

    iput v0, v1, Lcom/autonavi/navigation/api/internal/ObjectId;->objectId:I

    new-instance v0, Lcom/autonavi/navigation/api/poi/model/Poi;

    iget v3, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lCategoryID:I

    iget v4, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lDistance:I

    iget v5, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lMatchCode:I

    iget v6, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lAdminCode:I

    iget-object v7, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->szName:Ljava/lang/String;

    iget-object v8, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->szAddr:Ljava/lang/String;

    iget-object v9, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->szTel:Ljava/lang/String;

    iget-short v10, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->siELonOff:S

    iget-short v11, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->siELatOff:S

    iget-short v12, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->usNodeId:S

    iget v13, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lHilightFlag:I

    iget-byte v14, p0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->ucFlag:B
...
.method public static a(Lcom/autonavi/navigation/api/poi/model/DisplayPoiPriority;)Lcom/autonavi/xm/navigation/server/poi/GDisplayPoiPriority;
    .locals 2

    new-instance v0, Lcom/autonavi/xm/navigation/server/poi/GDisplayPoiPriority;

    invoke-direct {v0}, Lcom/autonavi/xm/navigation/server/poi/GDisplayPoiPriority;-><init>()V

    invoke-virtual {p0}, Lcom/autonavi/navigation/api/poi/model/DisplayPoiPriority;->getPoiDisplayLevel()I

    move-result v1

    iput v1, v0, Lcom/autonavi/xm/navigation/server/poi/GDisplayPoiPriority;->poiDisplayLevel:I

    invoke-virtual {p0}, Lcom/autonavi/navigation/api/poi/model/DisplayPoiPriority;->getCategory()I

    move-result v1

    iput v1, v0, Lcom/autonavi/xm/navigation/server/poi/GDisplayPoiPriority;->nCategory:I

    return-object v0
.end method

.method public static a(Lcom/autonavi/navigation/api/poi/model/Poi;)Lcom/autonavi/xm/navigation/server/poi/GPoi;
    .locals 4
    ...
    iput-object v2, v0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->Coord:Lcom/autonavi/xm/navigation/server/GCoord;
    ...
    iput v1, v0, Lcom/autonavi/xm/navigation/server/poi/GPoi;->lPoiId:I
