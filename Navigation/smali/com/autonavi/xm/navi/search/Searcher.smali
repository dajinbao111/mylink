.class public Lcom/autonavi/xm/navi/search/Searcher;
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchAround:Z

    iput-boolean v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByPhone:Z

    iput-boolean v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByAddress:Z

    iput-boolean v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsRequestPoi:Z

    new-instance v0, Lcom/autonavi/xm/navi/search/Searcher$1;

    invoke-direct {v0, p0}, Lcom/autonavi/xm/navi/search/Searcher$1;-><init>(Lcom/autonavi/xm/navi/search/Searcher;)V

    iput-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mOnPoiQueryResultListener:Lcom/autonavi/navigation/api/poi/PoiManager$OnPoiQueryResultListener;

    iput-boolean v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mSearchAroundByDest:Z

    return-void
.end method

.method static synthetic access$000(Lcom/autonavi/xm/navi/search/Searcher;)Z
    .locals 1

    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->isOnTop()Z
...
.method static synthetic access$100(Lcom/autonavi/xm/navi/search/Searcher;)Lcom/autonavi/xm/navigation/app/NaviDialogFragment;
    .locals 1

    iget-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mDlgSearching:Lcom/autonavi/xm/navigation/app/NaviDialogFragment;

    return-object v0
.end method

.method static synthetic access$200(Lcom/autonavi/xm/navi/search/Searcher;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/autonavi/xm/navi/search/Searcher;->showPoiData(Ljava/util/List;)V
...
.method private showPoiData(Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->getActivity()Lcom/autonavi/xm/support/app/FragmentActivity;

    move-result-object v2

    const-class v3, Lcom/autonavi/xm/navi/search/SearchResult;
    ...
    iget-boolean v2, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByAddress:Z

    invoke-virtual {v1, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v0, "extra_by_around_search"

    iget-boolean v2, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchAround:Z

    invoke-virtual {v1, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v0, "extra_by_phone_search"

    iget-boolean v2, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByPhone:Z

    invoke-virtual {v1, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v0, "extra_is_request_poi"

    iget-boolean v2, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsRequestPoi:Z

    invoke-virtual {v1, v0, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    iget-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsRequestPoi:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    invoke-virtual {p0, v1, v0}, Lcom/autonavi/xm/navi/search/Searcher;->startFragmentForResult(Landroid/content/Intent;I)V

    :goto_0
    return-void

    :cond_0
    invoke-virtual {p0, v1}, Lcom/autonavi/xm/navi/search/Searcher;->startFragment(Landroid/content/Intent;)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0, v1, p3}, Lcom/autonavi/xm/navi/search/Searcher;->setResult(ILandroid/content/Intent;)V

    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->popBack()V
...
.method protected onCreateView(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mHost:Lcom/autonavi/xm/navi/main/activity/NavigationMapActivity;
    ...
    iput-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mDataManager:Lcom/autonavi/navigation/api/data/DataManager;
    ...
    iput-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mGuideManager:Lcom/autonavi/navigation/api/guide/GuideManager;
    ...
    iput-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mPoiManager:Lcom/autonavi/navigation/api/poi/PoiManager;

    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->getArguments()Landroid/os/Bundle;
    ...
    iput-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsRequestPoi:Z

    :cond_0
    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->onPreRegisterOnNaviServiceStartListener()V
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mOnPoiQueryResultListener:Lcom/autonavi/navigation/api/poi/PoiManager$OnPoiQueryResultListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mPoiManager:Lcom/autonavi/navigation/api/poi/PoiManager;

    iget-object v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mOnPoiQueryResultListener:Lcom/autonavi/navigation/api/poi/PoiManager$OnPoiQueryResultListener;
...
.method protected searchAround(Lcom/autonavi/navigation/api/poi/model/Poi;ILjava/lang/String;Z)V
    ...
    iput-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchAround:Z

    if-eqz p4, :cond_0

    invoke-direct {p0}, Lcom/autonavi/xm/navi/search/Searcher;->showDlgSearching()V
...
.method protected searchAroundAlongRoute(IZ)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/autonavi/xm/navi/search/Searcher;->searchAroundAlongRoute(ILjava/lang/String;Z)V
...
.method protected searchAroundAlongRoute(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lcom/autonavi/xm/navi/search/Searcher;->searchAroundAlongRoute(ILjava/lang/String;Z)V
...
.method protected searchAroundByDest(I)V
    ...
    iput p1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mCategoryId:I

    invoke-direct {p0}, Lcom/autonavi/xm/navi/search/Searcher;->showDlgSearching()V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mSearchAroundByDest:Z
...
.method protected searchByAddress(Ljava/lang/String;ZI)V
    ...
    iput-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByAddress:Z
    ...
    iget-object v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mHost:Lcom/autonavi/xm/navi/main/activity/NavigationMapActivity;

    invoke-virtual {v1}, Lcom/autonavi/xm/navi/main/activity/NavigationMapActivity;->getAnMap()Lcom/autonavi/navigation/api/map/AnMap;
    ...
    iget-object v1, p0, Lcom/autonavi/xm/navi/search/Searcher;->mPoiManager:Lcom/autonavi/navigation/api/poi/PoiManager;

    iget-object v2, p0, Lcom/autonavi/xm/navi/search/Searcher;->mOnPoiQueryResultListener:Lcom/autonavi/navigation/api/poi/PoiManager$OnPoiQueryResultListener;
...
.method protected searchByPhone(Ljava/lang/String;ZI)V
    ...
    iput-boolean v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mIsSearchByPhone:Z
...
.method protected showErrorToast(I)V
    ...
    iget-object v0, p0, Lcom/autonavi/xm/navi/search/Searcher;->mHost:Lcom/autonavi/xm/navi/main/activity/NavigationMapActivity;
...
.method protected showSoftInput(Landroid/view/View;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/autonavi/xm/navi/search/Searcher;->getInputMethodManager()Lcom/autonavi/xm/ime/InputMethodManager;

    move-result-object v0

    check-cast p1, Lcom/autonavi/xm/ime/widget/EditText;

    invoke-virtual {v0, p1}, Lcom/autonavi/xm/ime/InputMethodManager;->showSoftInput(Lcom/autonavi/xm/ime/widget/EditText;)V
